 ...
 */
contract StreamswapFeeCollector is IStreamswapFeeCollector, Authentication, ReentrancyGuard {
    ...
    function getFlashLoanFeePercentage() public view override returns (uint256) {
